...
func (this *VariableInfo) Name_MetaFFIGetter() (name string, err error){
...
func (this *VariableInfo) Type_MetaFFIGetter() (type__ string, err error){
...
func (this *VariableInfo) IsStatic_MetaFFIGetter() (IsStatic bool, err error){
...
func (this *VariableInfo) IsFinal_MetaFFIGetter() (IsFinal bool, err error){
...
func (this *ParameterInfo) Name_MetaFFIGetter() (name string, err error){
...
func (this *ParameterInfo) Type_MetaFFIGetter() (type__ string, err error){
...
func (this *MethodInfo) Name_MetaFFIGetter() (name string, err error){
...
func (this *MethodInfo) IsStatic_MetaFFIGetter() (IsStatic bool, err error){
...
func (this *MethodInfo) Comment_MetaFFIGetter() (Comment string, err error){
...
func (this *MethodInfo) Parameters_MetaFFIGetter() (Parameters []ParameterInfo, err error){
...
func (this *MethodInfo) ReturnValue_MetaFFIGetter() (return_values ParameterInfo, err error){
...
func (this *ClassInfo) Name_MetaFFIGetter() (name string, err error){
...
func (this *ClassInfo) Comment_MetaFFIGetter() (Comment string, err error){
...
func (this *ClassInfo) Package_MetaFFIGetter() (Package string, err error){
...
func (this *ClassInfo) Fields_MetaFFIGetter() (fields []VariableInfo, err error){
...
func (this *ClassInfo) Methods_MetaFFIGetter() (methods []MethodInfo, err error){
...
func (this *ClassInfo) Constructors_MetaFFIGetter() (constructors []MethodInfo, err error){
...
func (this *JavaInfo) Classes_MetaFFIGetter() (classes []ClassInfo, err error){
