...
func NewJavaIDLCompiler() *JavaIDLCompiler {
	...
	MetaFFILoad(fmt.Sprintf("%v/JavaExtractor_MetaFFIGuest%v;%v/JavaExtractor.jar;%v/asm-9.6.jar;%v/asm-tree-9.6.jar;%v/javaparser-core-3.24.4.jar;%v/JavaExtractor_MetaFFIGuest.jar", p, ext, p, p, p, p, p))
