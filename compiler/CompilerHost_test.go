...
func TestJavaHost(t *testing.T) {
	...
	cmp := NewHostCompiler()
	err = cmp.Compile(def, "temp", "HostTest", nil)
	if err != nil {
		t.Fatal(err)
		return
	}
